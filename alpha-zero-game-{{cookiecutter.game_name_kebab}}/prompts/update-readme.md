...
user to confirm they want to update [README.md](../README.md) again, and clarify
...
[README.md](../README.md) with a short description. Stating that this repo is
an implementation of <https://github.com/shuyangsun/alpha-zero-api>.
