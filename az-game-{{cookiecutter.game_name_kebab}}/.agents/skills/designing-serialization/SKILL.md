...
# Designing the {{cookiecutter.game_name}} serializer

Write a design doc covering both halves of
[serializer.h](../../../include/{{cookiecutter.game_slug}}/serializer.h)
and the matching
[deserializer.h](../../../include/{{cookiecutter.game_slug}}/deserializer.h)
...
7. **History.** The engine passes a
   `RingBufferView<{{cookiecutter.__game_cls}}>` of size up to
